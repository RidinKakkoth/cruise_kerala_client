...
chat </button>
      <button onClick={handleNotification} className='bg-indigo-500 text-white gap-2 rounded h-10 w-36 flex justify-center items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
