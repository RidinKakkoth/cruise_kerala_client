...
return (
  ...
  <button className="ms-5 mt-3 flex gap-2 rounded bg-indigo-500 px-2 py-1 w-20 text-white">back <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
