...
//                   <td className="p-3 text-sm text-gray-700 whitespace-nowrap">{booking.userId.email}</td>
...
function BookingData() {
  ...
  const cancelBook=async(id)=>{  //check out================>
                ...
                <div className='px-2'>
                  ...
                  >
                    {booking.status}
                                                    ...
                                                    {
  booking?.status === "Booked" && new Date(booking.checkIn) > new Date() ? (
    <button  className="font-medium text-sm border flex justify-around gap-2 rounded-xl text-white hover:bg-red-500 py-1 shadow bg-red-400 px-1 w-20">
      Cancel
    </button>
  ) : booking?.status === "Cancelled" ? (
    <p  className="font-medium border  flex justify-around text-sm gap-2 cursor-default rounded-xl text-white py-1 shadow bg-red-500 px-1 w-20">
